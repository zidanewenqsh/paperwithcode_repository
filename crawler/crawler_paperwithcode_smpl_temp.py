...
if __name__ == "__main__":
    ...
    target_url = f"https://paperswithcode.com/search?q_meta=&q_type=&q=smpl&page=16"  # 替换为目标网站的URL
    ...
    # 获取目标页面并处理
    results = spider.resp(target_url, False, treatbase, [hrefxpath, imgxpath, titlexpath], pattern)
    print(len(results))
    print(results)
